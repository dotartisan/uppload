 ...
 */
export declare const getElements: (query?: IElements | undefined) => Element[];
/**
 ...
 */
export declare const fitImageToContainer: (params: IHandlersParams, image: HTMLImageElement | HTMLVideoElement) => Promise<void>;
/**
