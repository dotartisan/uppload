(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.uppload = {}, global.createFocusTrap, global.mitt, global.Cropper));
})(this, (function (exports, focusTrap, mitt, Cropper) { 'use strict';
  ...
  <div></div>
        ...
        next(file) {
            ...
            if (this.activeEffect) ;
                ...
                if (this.effects.length &&
                    ...
                    ((_a = this.settings.skipEditMimes) === null || _a === void 0 ? void 0 : _a.indexOf(file.type))) {
    ...
    const generateFileName$1 = (file, service) => {
                        ...
                        if (input) {
                            ...
                            if (this.name === "screenshot") {
                                imageUrlToBlob(`https://api.microlink.io?url=${encodeURIComponent(url)}&screenshot=true&meta=false&embed=screenshot.url`)
                                    .then((blob) => params.next(generateFileName$1(blobToUpploadFile(blob), this.name)))
                ...
                for (let i = 0; i < files.length; i++) {
                    ...
                    if (this.mimeTypes.indexOf(item.type) !== -1)
                        if (item.size < this.maxFileSize)
                            ...
                            params.handle(new Error(params.translate("errors.file_too_large", formatBytes(this.maxFileSize))));
                }
            }
            if (!file)
                return;
            ...
            this.handlers = (params) => {
                ...
                if (cropperElement) {
                    fitImageToContainer(params, cropperElement).then(() => {
                        const cropper = new Cropper__default["default"](cropperElement, {
            ...
            this.handlers = (params) => {
                ...
                if (rotatorElement) {
                    fitImageToContainer(params, rotatorElement).then(() => {
                        const rotator = new Cropper__default["default"](rotatorElement, {
                            autoCropArea: 1,
                            viewMode: 1,
                            dragMode: "none",
