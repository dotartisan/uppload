...
test("gets button HTML", () =>
  expect(minifyHTML(service.getButton(pexelsResult))).toBe(
    `<div class="result"><button aria-label="Anand Chowdhary" data-full-url="https://pexels.com/large.jpg" data-metadata="%7B%22caption%22%3A%22Pexels%22%2C%22alt%22%3A%22Pexels%22%2C%22author%22%3A%22Anand%20Chowdhary%22%2C%22link%22%3A%22https%3A%2F%2Fpexels.com%2Fimage%22%7D" style="background-image: url('https://pexels.com/tiny.jpg')"></button><small class="author"><span>Anand Chowdhary</span></small></div>`
  ));
